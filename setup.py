#!/usr/bin/env python3
# This file is part of the account_invoice_ar_currency module for Tryton.
...
LINKS = {
    'trytonar_account_invoice_ar': ('git+https://github.com/tryton-ar/'
        'account_invoice_ar.git@%s.%s#egg=trytonar_account-invoice-ar-%s.%s' %
...
setup(name='%s_%s' % (PREFIX, MODULE),
    version=version,
    description='Tryton module to add currency in price lists',
    ...
    keywords='tryton, invoice, account, argentina, currency',
